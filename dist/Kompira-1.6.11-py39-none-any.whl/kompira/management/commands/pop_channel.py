    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if not isinstance(chan, Channel):
                raise CommandError(u'Specified path object is not channel.')
            with transaction.atomic():
                lock_object([chan], comment=u"pop_channel(%s)" % chan)
                ...
                for n in range(count):
                    ...
                    msg = chan.pop_message(index=index)
                    ...
                    if verbose:
                        ...
                        verbose_out.write("Message Index: %s" % (index + n))
            ...
            raise CommandError(u'Specified path object does not exist.')
        except Exception as e:
            raise CommandError(u'Failed: %s' % smart_str(e))
